...
module Test.Protocols.Packetstream.PacketArbiter where
...
-- Me
import Protocols.PacketStream.PacketArbiter
...
prop_packetarbiter_parallel_id = makePropPacketArbiter C.d1 C.d2 Protocols.PacketStream.PacketArbiter.Parallel
...
prop_packetarbiter_parallel = makePropPacketArbiter C.d5 C.d2 Protocols.PacketStream.PacketArbiter.Parallel
